...
class QualityFlagsResponse(BaseModel):
    """Ответ с полным набором флагов качества из compute_quality_flags."""
...
# ---------- /quality-flags-from-csv: полный набор флагов из ядра ----------
...
async def quality_flags_from_csv(file: UploadFile = File(...)) -> QualityFlagsResponse:
    """
    Эндпоинт, который принимает CSV-файл и возвращает полный словарь
    флагов качества из compute_quality_flags (включая новые флаги HW03).
    """
